...
<div class="container mt-5  mb-5">
    <form method="POST" name="Update_pilot">
        ...
        <div class="container d-flex justify-content-around">
            ...
            <button type="button" onclick="getIDupdate();" class="buttonupd btn btn-primary w-25" id="btn_update" value="Update_student" name="Update_student" data-bs-toggle="modal" data-bs-target="#updatemodal" disabled>Update</button>
